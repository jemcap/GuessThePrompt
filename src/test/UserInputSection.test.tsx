...
import UserInputSection from '../components/game/UserInputSection';
...
describe('UserInputSection', () => {
  ...
  describe('Initial Rendering', () => {
    it('renders the input section with correct initial state', () => {
      ...
      expect(screen.getByText('Characters: 0/1000')).toBeInTheDocument();
    });

    it('disables submit button when input is empty', () => {
      render(<UserInputSection {...mockProps} />);
      
      const submitButton = screen.getByText('Submit Final Answer');
  ...
  describe('User Input', () => {
    ...
    it('updates character count as user types', () => {
      ...
      expect(screen.getByText(`Characters: ${testText.length}/1000`)).toBeInTheDocument();
    });
